...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'details', component: DetailsLeaveComponent },
  ...
  },
  {
  ...
  },
   {
    ...
    children: [
      ...
      { path: 'details', component: DetailsSalaryComponent },
      { path: 'manage', component: ManageSalaryComponent },
      { path: 'user', component: UserSalaryComponent },
    ],
  },
